...
beforeEach(function (done) {
  this.plugin = new fixtures.plugin('domain-limit')
  done()  // if a test hangs, assure you called done()
})

describe('domain-limit', function () {
...
describe('load_domain-limit_ini', function () {
  it('loads domain-limit.ini from config/domain-limit.ini', function (done) {
    this.plugin.load_domain-limit_ini()
